...
const config = {
  ...
  "inlineSchemaHash": "d8d9ed7a6cb2cf9ddd30054131bd6d48c6a4e507ae016a752e458de7403f0667",
  "copyEngine": true
}
...
if (!fs.existsSync(path.join(__dirname, 'schema.prisma'))) {
  const alternativePaths = [
    "apps/auth-service/generated/prisma",
    "auth-service/generated/prisma",
  ]
...
path.join(process.cwd(), "apps/auth-service/generated/prisma/query_engine-windows.dll.node")
// file annotations for bundling tools to include these files
path.join(__dirname, "schema.prisma");
path.join(process.cwd(), "apps/auth-service/generated/prisma/schema.prisma")
